...
type Status struct {
	...
	Code    int32        `protobuf:"varint,1,opt,name=code,proto3" json:"status_code,omitempty"`
	Message string       `protobuf:"bytes,2,opt,name=message,proto3" json:"status_message,omitempty"`
