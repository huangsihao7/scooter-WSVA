...
var file_feed_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x22, 0x45, 0x0a, 0x14, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x6c, 0x69,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x83, 0x01, 0x0a, 0x15, 0x70, 0x75,
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x56,
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x22, 0x0a, 0x06, 0x61, 0x75, 0x74,
	...
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x51, 0x0a, 0x07,
	0x46, 0x65, 0x65, 0x64, 0x53, 0x72, 0x76, 0x12, 0x46, 0x0a, 0x0b, 0x50, 0x75, 0x62, 0x6c, 0x69,
	0x73, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1a, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73,
...
var file_feed_proto_goTypes = []interface{}{
	(*PublishListRequest)(nil),  // 0: feed.publish_list_request
	(*PublishListResponse)(nil), // 1: feed.publish_list_response
	(*Video)(nil),               // 2: feed.Video
	(*User)(nil),                // 3: feed.User
}
var file_feed_proto_depIdxs = []int32{
	2, // 0: feed.publish_list_response.video_list:type_name -> feed.Video
	3, // 1: feed.Video.author:type_name -> feed.User
	0, // 2: feed.FeedSrv.PublishList:input_type -> feed.publish_list_request
	1, // 3: feed.FeedSrv.PublishList:output_type -> feed.publish_list_response
