...
type DanmuActionRequest struct {
	...
	SendTime  string `protobuf:"bytes,4,opt,name=send_time,json=sendTime,proto3" json:"send_time,omitempty"`    // 用户填写的评论内容，在action_type=1的时候使用
}
...
func (x *DanmuActionRequest) GetSendTime() string {
	if x != nil {
		return x.SendTime
	}
	return ""
...
type DanMu struct {
	...
	SendTime  string `protobuf:"bytes,5,opt,name=send_time,json=sendTime,proto3" json:"send_time,omitempty"`    // 用户填写的评论内容，在action_type=1的时候使用
}
...
func (x *DanMu) GetSendTime() string {
	if x != nil {
		return x.SendTime
	}
	return ""
...
var file_comment_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x73, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x57, 0x0a, 0x15, 0x64,
	...
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x65, 0x6e,
